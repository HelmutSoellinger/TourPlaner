...
{
    internal class TourViewModel : BaseViewModel
    {
        private readonly EditButtonViewModel editButtonViewModel;
        ...
        */
        ...
        public TourModel? SelectedTour
        {
            ...
            {
                selectedTour = value;
                editButtonViewModel.SelectedTour = value;
       ...
       /// </summary>
        ...
        public TourViewModel(EditButtonViewModel editButtonViewModel)
        {
            this.editButtonViewModel = editButtonViewModel;

            // AddNewTourCommand = new RelayCommand((_) =>
            editButtonViewModel.AddButtonClicked += (sender, tour) =>
            {
                Debug.Print("Adding new tour: " + tour.Date);
                Tours.Add(tour);
                OnPropertyChanged(nameof(Tours));

                editButtonViewModel.NewTourName = "";
                /*
          ...
          //  );
            ...
            editButtonViewModel.DeleteButtonClicked += (sender, tour) =>
            {
        ...
        {
            editButtonViewModel = new EditButtonViewModel();
        }
    }
}
